...
Download all repos, then in command line for each project run npm install. After that, you should be able to run npm rum build for each project. From there, you can visit localhost:XXXX to enter the website, and that should provide linking to the other components.
